...
insert into m_topic_info(order_detail, order_rowno, project_nm, customer, group_id, disp_seq, del_flg, modified_date) values
    ('ZAB202300064', '1', '【AE0172420】AFP,ACSｼｽﾃﾑｻﾎﾟｰﾄ2024上期', '旭化成エンジニアリング株式会社', 'AA000', 1, '0', current_timestamp)
    , ('ZAB202300095', '2', '【AE0174795】KJ様　ｻｰﾊﾞｰﾒﾝﾃﾅﾝｽ手順書作成', '旭化成エンジニアリング株式会社', 'AA000', 2, '0', current_timestamp)
    , ('ZAB202300099', '1', '【AE0174850】調合原材料天秤計量ｼｽﾃﾑ追加', '旭化成エンジニアリング株式会社', 'AA000', 3, '0', current_timestamp)
;
